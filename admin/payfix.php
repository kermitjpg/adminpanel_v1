...
if (isset($_POST['sil']) && $_SESSION["yetki"] == "1") {
    ...
    $sorgu = $baglanti->prepare('DELETE FROM payfix WHERE id IN (' . $silinecekler . ')');
    $sorgu->execute();
    if ($sorgu) {
    ...
    Swal.fire({
        ...
        if (value.isConfirmed) {
            window.location.href = 'payfix.php'
        }
    })
</script>";
    }
...
?>
    ...
    <main>
        ...
        <div class="container-fluid px-5 py-4">
            <div class="row">
                <h2 class="text-center pt-2 pb-5">PayFix Toplam Kasa
                    Tutarı: <?= /* Sorgu ahead.php'de tanımlı */
                    $payfixTopla["tutar"] ?>₺</h2>


                <!-- EDİT -->
                <!-- Onaylanan ödemeler sayı bilgisi -->
                <?php
                $onayOkundu = $baglanti->prepare("SELECT COUNT(*) AS sayi FROM payfix WHERE aktif=1");
                $onayOkundu->execute();
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <?php
                    $redOkundu = $baglanti->prepare("SELECT COUNT(*) AS sayi FROM payfix WHERE aktif=2");
                    $redOkundu->execute();
                        ...
                        <div class="card text-white text-center bg-warning bg-gradient mb-3"
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><span id="okunmaSayisi"
                                                             class="text-light"> <?= $sonucOkundu3["sayi"] ?></span>
                                    Ödeme</h5>
                                <p class="card-text"></p>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table id="" class="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Payfix Kullanıcı</th>
                                ...
                                $sorgu = $baglanti->prepare("select * from payfix order by okundu");
                                $sorgu->execute();
                                while ($sonuc = $sorgu->fetch()) {
                                    ...
                                    <tr <?php if ($sonuc["okundu"] == 0) echo 'class="fw-bold"' ?>>
                                        ...
                                        <td class="text-center"><?= $sonuc["payfix_kullanici"] ?></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button class="btn btn-success btn-sm oku"
                                                    type="button"
                                            ...
                                            <button class="btn btn-danger btn-sm oku"
                                                    type="button"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="sil.php?id=<?= $sonuc["id"] ?>&tablo=payfix"
...
if ($_POST) { ///veri güncelle
    $guncelleSorgu = $baglanti->prepare("Update payfix set aktif=:aktif WHERE id=:id");
